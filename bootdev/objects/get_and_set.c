/**Get and Set:
 * 
 * So I an make empty arrays, which is pretty useless, but at least the 
 * bones are there. Now let's make them useful by allowing me to store
 * and retrieve values from the array
 *      ▫️ snek_array_set - sets a value at a specified index in the array
 *        (this is effectively array[3] = new_value in Python)
 *      ▫️ snek_array_get - gets a value at a specific index in the array
 *        (effectively array[7] in Python)
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
