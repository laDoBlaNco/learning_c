/**Mark:
 *
 * In some mark and sweep implementations I'll see different ways to
 * mark 'root objects' - the objects directly referenced by stack
 * frames. However, in my simplistic VM it's a bit easier to find and
 * mark all of the directly referenced objects. I'll see why when
 * I write it in a sec.
 */
#include <stdio.h>
#include <stdbool.h>
