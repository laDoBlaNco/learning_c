/**Frame References:
 *
 * When working with scopes we need to keep track of all of the 
 * references to the different objects. Though my version will be
 * super simplified its a idea of what is happening here. Each 
 * stack frame needs to know about all the objects that it references
 *
 */
#include <stdio.h>
#include <stdbool.h>
